...
export default function Template(){
  ...
  return(
    <div className="bg-[#FBE209] ">
      ...
      <div className="absolute bottom-[35%] left-0 lg:top-[-25%] lg:left-[48%] rotate-[-22.07deg]"><img style={style}  className=' w-[300px] md:w-[600px]' src='src/bestseller/3.png'/></div>
    </div>
    <style>{`
